...
public enum Opcode implements Instruction {
	...
	/* 04 */ beq(Kind.REL_JUMP),
	/* 05 */ bne(Kind.REL_JUMP),
	/* 06 */ blez(Kind.REL_JUMP), 
	/* 07 */ bgtz(Kind.REL_JUMP),
	/* 08 */ addi,
	/* 09 */ addiu,
	/* 0a */ slti,
	/* 0b */ sltiu,
	...
	/* 12 */ _12,
	/* 13 */ _13,
	/* 14 */ beql(Kind.REL_JUMP),
	/* 15 */ bnel(Kind.REL_JUMP),
	/* 16 */ blezl(Kind.REL_JUMP),
	/* 17 */ bgtzl(Kind.REL_JUMP),
	/* 18 */ _18,
	/* 19 */ _19,
	/* 1a */ _1a,
	/* 1b */ _1b,
