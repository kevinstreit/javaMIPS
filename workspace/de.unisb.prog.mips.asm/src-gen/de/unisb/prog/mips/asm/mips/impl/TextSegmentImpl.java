 ...
 * <ul>
 *   <li>{@link de.unisb.prog.mips.asm.mips.impl.TextSegmentImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TextSegmentImpl extends MinimalEObjectImpl.Container implements TextSegment
{
  /**
  ...
  {
    return MipsPackage.Literals.TEXT_SEGMENT;
  }
  ...
  public EList<TextItem> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<TextItem>(TextItem.class, this, MipsPackage.TEXT_SEGMENT__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case MipsPackage.TEXT_SEGMENT__ITEMS:
